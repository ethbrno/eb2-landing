...
<div class="flex justify-center min-h-screen items-center bg-[#15202B] text-white transition-all pt-2 pb-2">
  <div class="text-center px-10 lg:px-4 lg:w-1/2 mt-4 mb-10">
    <div class="text-center mb-8"><a href="https://docs.ethbrno.cz/events/2022"><img src="/logo-red.png" class="inline-block w-[300px] animate-pulse hover:animate-none hover:w-[400px] transition-all" /></a></div>
